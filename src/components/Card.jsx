                ...
                content.map((x) => (
                    ...
                    <div className="card" key={x.id}>
                        ...
                        <div className="bottom-section">
                            <span className="title">UNIVERSE OF YT</span>
                            <div className="row row1">
                                <div className="item">
                                    <span className="big-text">{x.score}</span>
                                    <span className="regular-text">Score</span>
                                </div>
                                <div className="item">
                                    <span className="big-text">100%</span>
                                    <span className="regular-text">Free </span>
                                </div>
                                <div className="item">
                                    <span className="big-text">{x.contributer}</span>
