                ...
                content.map((x) => (
                    ...
                    <div class="card" key={x.id}>
                        ...
                        <div class="bottom-section">
                            <span class="title">UNIVERSE OF YT</span>
                            <div class="row row1">
                                <div class="item">
                                    <span class="big-text">{x.score}</span>
                                    <span class="regular-text">Score</span>
                                </div>
                                <div class="item">
                                    <span class="big-text">100%</span>
                                    <span class="regular-text">Free </span>
                                </div>
                                <div class="item">
                                    <span class="big-text">{x.contributer}</span>
